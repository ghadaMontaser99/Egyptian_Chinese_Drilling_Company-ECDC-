...
@Component({
  selector: 'app-chart-drill-wit-manager-name',
  templateUrl: './chart-drill-wit-manager-name.component.html',
  styleUrls: ['./chart-drill-wit-manager-name.component.scss']
})
export class ChartDrillWitManagerNameComponent {
  ...
  onYearChange(event: any) {
    ...
    console.log("this yearrrrrrr",this.Year)
  }
  ...
  onChangeByMonth(event: any) {
    ...
    this.dataService.GetDrillAnalysisWithCompareByMonth(this.month1, this.month2, this.User.Role).subscribe({
      next: data => {
        console.log("dataaaaaaaaaaaaa")
        console.log(data.data)
        this.clearChart("myChart")
        data.data.forEach((element: { date: Date; drillTypeName: string; }) => {
          const validDate = new Date(element.date)

          console.log(validDate.getMonth() + 1)
          console.log("element.drillTypeName",element.drillTypeName)
          if ( element.drillTypeName == 'other' && (validDate.getMonth() + 1) == this.month1) {
            this.other_Month1.push(element)
          }
         else if (element.drillTypeName == 'other' && (validDate.getMonth() + 1) == this.month2) {
            this.other_Month2.push(element)
          }
          else if ( element.drillTypeName == 'Confined space' && (validDate.getMonth() + 1) == this.month1) {
            this.ConfinedSpace_Month1.push(element)
          }
          else if ( element.drillTypeName == 'Confined space' && (validDate.getMonth() + 1) == this.month2) {
            this.ConfinedSpace_Month2.push(element)
          }
          else if (element.drillTypeName == 'Spill Drill' && (validDate.getMonth() + 1) == this.month1) {
            this.SpillDrill_Month1.push(element)
          }
          else if (element.drillTypeName == 'Spill Drill' && (validDate.getMonth() + 1) == this.month2) {
            this.SpillDrill_Month2.push(element)
          }
          else if (element.drillTypeName == 'Evacuation' && (validDate.getMonth() + 1) == this.month1) {
            this.Evacuation_Month1.push(element)
          }
          else if (element.drillTypeName == 'Evacuation' && (validDate.getMonth() + 1) == this.month2) {
            this.Evacuation_Month2.push(element)
          }
          else if (element.drillTypeName == 'Fire and first aid' && (validDate.getMonth() + 1) == this.month1) {
            this.FireAndFirstAid_Month1.push(element)
          }
          else if (element.drillTypeName == 'Fire and first aid' && (validDate.getMonth() + 1) == this.month2) {
            this.FireAndFirstAid_Month2.push(element)
          }
          else if (element.drillTypeName == 'First aid' && (validDate.getMonth() + 1) == this.month1) {
            this.FireAid_Month1.push(element)
          }
          else if (element.drillTypeName == 'First aid' && (validDate.getMonth() + 1) == this.month2) {
            this.FireAid_Month2.push(element)
          }
          else if (element.drillTypeName == 'Fire' && (validDate.getMonth() + 1) == this.month1) {
            this.Fire_Month1.push(element)
          }
          else if (element.drillTypeName == 'Fire' && (validDate.getMonth() + 1) == this.month2) {
            this.Fire_Month2.push(element)
          }
          else if (element.drillTypeName == 'Kick' && (validDate.getMonth() + 1) == this.month1) {
            this.Kick_Month1.push(element)
          }
          else if (element.drillTypeName == 'Kick' && (validDate.getMonth() + 1) == this.month2) {
            this.Kick_Month2.push(element)
          }
          else if (element.drillTypeName == 'H2s' && (validDate.getMonth() + 1) == this.month1) {
            this.HS_Month1.push(element)
          }
          else if (element.drillTypeName == 'H2s' && (validDate.getMonth() + 1) == this.month2) {
  ...
  onChangeByYear(event: any) {
    ...
    const selectedText = selectedOption.text;
    this.temp = true;
    this.dataService.GetDrillAnalysisWithCompareByYear(this.Year,this.User.Role).subscribe({
      next: data => {
        console.log('dataaaaaaaaaa',data.data)
        this.clearChart("myChart2")
        data.data.forEach((element: { drillTypeName: string; }) => {
          console.log('element')
          console.log(element)
