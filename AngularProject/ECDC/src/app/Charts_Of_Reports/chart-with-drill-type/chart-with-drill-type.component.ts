...
export class ChartWithDrillTypeComponent {
    ...
    this.dataService.GetDrillTypeList().subscribe({
      next: data => {
        data.data.forEach((element: { name: string; }) => {
          ...
          console.log("eeeeeeeee", this.DrillType)
        });
      }
    }),
  ...
  onChangeWithRig(event: any) {

    this.Rig = event.target.value
    console.log("riggggggggg", this.Rig)
  ...
  onChangeByMonth(event: any) {
    ...
    this.dataService.GetDrillByMonth(this.month1, this.month2,  this.User.Role, this.Rig).subscribe({
      next: data => {
        console.log("dataaaaaaaaaaaaa")
        console.log(data.data)
        this.clearChart("myChart")
        data.data.forEach((element: { rigId:number; date: Date; drillTypeName: string; }) => {
          const validDate = new Date(element.date)

          console.log(validDate.getMonth() + 1)
          if (element.rigId==this.Rig&&element.drillTypeName == 'other' && (validDate.getMonth() + 1) == this.month1) {
            this.other_Month1.push(element)
          }
          if (element.rigId==this.Rig&&element.drillTypeName == 'other' && (validDate.getMonth() + 1) == this.month2) {
            this.other_Month2.push(element)
          }
          else if (element.rigId==this.Rig&& element.drillTypeName == 'Confined space' && (validDate.getMonth() + 1) == this.month1) {
            this.ConfinedSpace_Month1.push(element)
          }
          else if (element.rigId==this.Rig&& element.drillTypeName == 'Confined space' && (validDate.getMonth() + 1) == this.month2) {
            this.ConfinedSpace_Month2.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Spill Drill' && (validDate.getMonth() + 1) == this.month1) {
            this.SpillDrill_Month1.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Spill Drill' && (validDate.getMonth() + 1) == this.month2) {
            this.SpillDrill_Month2.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Evacuation' && (validDate.getMonth() + 1) == this.month1) {
            this.Evacuation_Month1.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Evacuation' && (validDate.getMonth() + 1) == this.month2) {
            this.Evacuation_Month2.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Fire and first aid' && (validDate.getMonth() + 1) == this.month1) {
            this.FireAndFirstAid_Month1.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Fire and first aid' && (validDate.getMonth() + 1) == this.month2) {
            this.FireAndFirstAid_Month2.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'First aid' && (validDate.getMonth() + 1) == this.month1) {
            this.FireAid_Month1.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'First aid' && (validDate.getMonth() + 1) == this.month2) {
            this.FireAid_Month2.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Fire' && (validDate.getMonth() + 1) == this.month1) {
            this.Fire_Month1.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Fire' && (validDate.getMonth() + 1) == this.month2) {
            this.Fire_Month2.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Kick' && (validDate.getMonth() + 1) == this.month1) {
            this.Kick_Month1.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Kick' && (validDate.getMonth() + 1) == this.month2) {
            this.Kick_Month2.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'H2s' && (validDate.getMonth() + 1) == this.month1) {
            this.HS_Month1.push(element)
          }
          else if (element.rigId==this.Rig&&element.drillTypeName == 'H2s' && (validDate.getMonth() + 1) == this.month2) {
  ...
  onChangeByYear(event: any) {
    ...
    this.dataService.GetDrillByYear(this.Year,this.User.Role,this.Rig).subscribe({
      next: data => {
        console.log('dataaaaaaaaaa',data.data)
        this.clearChart("myChart2")
        data.data.forEach((element: { rigId: number; drillTypeName: string; }) => {
          console.log('element')
          console.log(element)
          if (element.rigId==this.Rig&& element.drillTypeName == 'other' ) {
            this.other_Year.push(element)
          }
          else if (element.rigId==this.Rig&& element.drillTypeName == 'Confined space' ) {
            this.ConfinedSpace_Year.push(element)
          }
         
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Spill Drill' ) {
            this.SpillDrill_Year.push(element)
          }
          
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Evacuation' ) {
            this.Evacuation_Year.push(element)
          }
          
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Fire and first aid' ) {
            this.FireAndFirstAid_Year.push(element)
          }
          
          else if (element.rigId==this.Rig&&element.drillTypeName == 'First aid' ) {
            this.FireAid_Year.push(element)
          }
          
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Fire' ) {
            this.Fire_Year.push(element)
          }
         
          else if (element.rigId==this.Rig&&element.drillTypeName == 'Kick' ) {
            this.Kick_Year.push(element)
          }
         
          else if (element.rigId==this.Rig&&element.drillTypeName == 'H2s' ) {
