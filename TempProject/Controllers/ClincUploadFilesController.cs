...
namespace TempProject.Controllers
{
    ...
    [ApiController]
    public class ClincUploadFilesController : ControllerBase
    {
        private readonly IWebHostEnvironment _environment;
        private readonly string _fileDirectory = "E:\\هدير\\ITI\\ECDC\\ECDC\\TempProject\\wwwroot\\uploads\\ClincUploadFiles";
        private const int PageSize = 10;
        public ClincUploadFilesController(IWebHostEnvironment environment)
        {
