...
namespace TempProject.Controllers
{
    ...
    [ApiController]
    public class QualityUploadFilesController : ControllerBase
    {
        private readonly IWebHostEnvironment _environment;
        private readonly string _fileDirectory = "E:\\هدير\\ITI\\ECDC\\ECDC\\TempProject\\wwwroot\\uploads\\QualityUploadFiles";
        private const int PageSize = 10;
        public QualityUploadFilesController(IWebHostEnvironment environment)
        {
