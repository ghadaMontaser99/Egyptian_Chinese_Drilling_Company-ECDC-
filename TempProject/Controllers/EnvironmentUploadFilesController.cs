...
namespace TempProject.Controllers
{
    ...
    [ApiController]
    public class EnvironmentUploadFilesController : ControllerBase
    {
        private readonly IWebHostEnvironment _environment;
        private readonly string _fileDirectory = "E:\\هدير\\ITI\\ECDC\\ECDC\\TempProject\\wwwroot\\uploads\\EnvironmentUploadFiles";
        private const int PageSize = 10;
        public EnvironmentUploadFilesController(IWebHostEnvironment environment)
        {
