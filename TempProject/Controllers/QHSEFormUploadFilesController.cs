...
namespace TempProject.Controllers
{
    ...
    [ApiController]
    public class QHSEFormUploadFilesController : ControllerBase
    {
        private readonly IWebHostEnvironment _environment;
        private readonly string _fileDirectory = "E:\\هدير\\ITI\\ECDC\\ECDC\\TempProject\\wwwroot\\uploads\\QHSEFormUploadFiles";
        private const int PageSize = 10;
        public QHSEFormUploadFilesController(IWebHostEnvironment environment)
        {
