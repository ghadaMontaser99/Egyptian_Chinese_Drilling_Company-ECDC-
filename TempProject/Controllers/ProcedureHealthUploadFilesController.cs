...
namespace TempProject.Controllers
{
    ...
    [ApiController]
    public class ProcedureHealthUploadFilesController : ControllerBase
    {
        private readonly IWebHostEnvironment _environment;
        private readonly string _fileDirectory = "E:\\هدير\\ITI\\ECDC\\ECDC\\TempProject\\wwwroot\\uploads\\ProcedureHealthUploadFiles";
        private const int PageSize = 10;
        public ProcedureHealthUploadFilesController(IWebHostEnvironment environment)
        {
