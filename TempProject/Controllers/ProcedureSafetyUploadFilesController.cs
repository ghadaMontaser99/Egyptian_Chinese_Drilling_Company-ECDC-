...
namespace TempProject.Controllers
{
    ...
    [ApiController]
    public class ProcedureSafetyUploadFilesController : ControllerBase
    {
        private readonly IWebHostEnvironment _environment;
        private readonly string _fileDirectory = "E:\\هدير\\ITI\\ECDC\\ECDC\\TempProject\\wwwroot\\uploads\\ProcedureSafetyUploadFiles";
        private const int PageSize = 10;
        public ProcedureSafetyUploadFilesController(IWebHostEnvironment environment)
        {
